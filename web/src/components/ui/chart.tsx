// shadcn/ui chart wrapper — built on Recharts
// Docs: https://ui.shadcn.com/docs/components/chart
import * as React from 'react';
import * as RechartsPrimitive from 'recharts';
import { cn } from '@/lib/utils';

// AlertaYa chart color palette (maps to CSS vars in index.css)
...
>(({ active, payload, className, indicator = 'dot', hideLabel = false, hideIndicator = false, label, labelFormatter, labelClassName, formatter, color, nameKey, labelKey }, ref) => {
  ...
  return (
    <div ref={ref} className={cn('grid min-w-[8rem] items-start gap-1.5 rounded-card border border-border/50 bg-popover px-2.5 py-1.5 text-xs shadow-xl', className)}>
