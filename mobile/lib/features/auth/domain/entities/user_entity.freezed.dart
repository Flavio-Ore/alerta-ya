...
abstract class $UserEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String uid, int reputationScore});
}
...
class _$UserEntityImpl implements _UserEntity {
  const _$UserEntityImpl({required this.uid, this.reputationScore = 100});
  ...
  @override
  String toString() {
    return 'UserEntity(uid: $uid, reputationScore: $reputationScore)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, uid, reputationScore);
...
abstract class _UserEntity implements UserEntity {
  const factory _UserEntity(
      ...
      final int reputationScore}) = _$UserEntityImpl;
